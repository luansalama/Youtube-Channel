...
$log = 'K:\Minecraft Narrative Studio\exports\runner-logs\20260715-195959-254880-studio-assistant-codex-gpt-5.6-sol.log'
$done = 'K:\Minecraft Narrative Studio\exports\runner-logs\20260715-195959-254880-studio-assistant-codex-gpt-5.6-sol.done'
$position = 0
Clear-Host
