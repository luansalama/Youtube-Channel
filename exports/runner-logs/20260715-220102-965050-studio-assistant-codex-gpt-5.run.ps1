...
$stdoutPath = 'K:\Minecraft Narrative Studio\exports\runner-logs\20260715-220102-965050-studio-assistant-codex-gpt-5.stdout.log'
$stderrPath = 'K:\Minecraft Narrative Studio\exports\runner-logs\20260715-220102-965050-studio-assistant-codex-gpt-5.stderr.log'
$logPath = 'K:\Minecraft Narrative Studio\exports\runner-logs\20260715-220102-965050-studio-assistant-codex-gpt-5.log'
$startedPath = 'K:\Minecraft Narrative Studio\exports\runner-logs\20260715-220102-965050-studio-assistant-codex-gpt-5.started'
$donePath = 'K:\Minecraft Narrative Studio\exports\runner-logs\20260715-220102-965050-studio-assistant-codex-gpt-5.done'
$exitPath = 'K:\Minecraft Narrative Studio\exports\runner-logs\20260715-220102-965050-studio-assistant-codex-gpt-5.exit'
$timeoutSeconds = 1800
$stdoutPosition = 0
$stderrPosition = 0
...
Write-Host "Focused structured output may remain silent until the complete proposal is ready." -ForegroundColor DarkGray
Write-Host "This window will remain open after success or failure." -ForegroundColor DarkGray
Write-Host ""
Set-Location -LiteralPath 'C:\Users\Admin\AppData\Local\Temp\mcstudio-codex-wtzai3ji'

Set-Content -LiteralPath $startedPath -Value "started" -Encoding utf8
Set-Content -LiteralPath $stdoutPath -Value "" -Encoding utf8
Set-Content -LiteralPath $stderrPath -Value "" -Encoding utf8
Set-Content -LiteralPath $logPath -Value ('Studio Assistant · Codex · gpt-5.6-sol · Focused proposal' + "`nWorking directory: " + 'C:\Users\Admin\AppData\Local\Temp\mcstudio-codex-wtzai3ji' + "`nCommand: " + 'K:\Applications\Codex\codex.EXE --search exec --ephemeral --ignore-user-config --ignore-rules --sandbox workspace-write --skip-git-repo-check --color never -C C:\Users\Admin\AppData\Local\Temp\mcstudio-codex-wtzai3ji -c approval_policy="on-request" -c approvals_reviewer="auto_review" -c windows.sandbox="elevated" -c web_search="live" --output-schema C:\Users\Admin\AppData\Local\Temp\mcstudio-codex-wtzai3ji\proposal-schema.json -o C:\Users\Admin\AppData\Local\Temp\mcstudio-codex-wtzai3ji\proposal.json -m gpt-5.6-sol -c model_reasoning_effort="max" -' + "`n") -Encoding utf8
$exitCode = 1
try {
    $start = @{
        ...
        WorkingDirectory = 'C:\Users\Admin\AppData\Local\Temp\mcstudio-codex-wtzai3ji'
        RedirectStandardOutput = $stdoutPath
        RedirectStandardError = $stderrPath
        PassThru = $true
        NoNewWindow = $true
        RedirectStandardInput = 'K:\Minecraft Narrative Studio\exports\runner-logs\20260715-220102-965050-studio-assistant-codex-gpt-5.stdin.txt'
    }
    ...
    while (-not $runner.HasExited) {
        ...
        if ($clock.Elapsed.TotalSeconds -ge $nextHeartbeat) {
            Write-Host ("Still working… " + [int]$clock.Elapsed.TotalSeconds + " seconds elapsed. No intermediate model output is expected.") -ForegroundColor DarkGray
            $nextHeartbeat += 30
        }
