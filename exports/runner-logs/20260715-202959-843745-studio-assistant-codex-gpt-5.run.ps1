...
$stdoutPath = 'K:\Minecraft Narrative Studio\exports\runner-logs\20260715-202959-843745-studio-assistant-codex-gpt-5.stdout.log'
$stderrPath = 'K:\Minecraft Narrative Studio\exports\runner-logs\20260715-202959-843745-studio-assistant-codex-gpt-5.stderr.log'
$logPath = 'K:\Minecraft Narrative Studio\exports\runner-logs\20260715-202959-843745-studio-assistant-codex-gpt-5.log'
$startedPath = 'K:\Minecraft Narrative Studio\exports\runner-logs\20260715-202959-843745-studio-assistant-codex-gpt-5.started'
$donePath = 'K:\Minecraft Narrative Studio\exports\runner-logs\20260715-202959-843745-studio-assistant-codex-gpt-5.done'
$exitPath = 'K:\Minecraft Narrative Studio\exports\runner-logs\20260715-202959-843745-studio-assistant-codex-gpt-5.exit'
$timeoutSeconds = 1800
$stdoutPosition = 0
$stderrPosition = 0
...
Set-Content -LiteralPath $logPath -Value ('Studio Assistant · Codex · gpt-5.6-sol' + "`nWorking directory: " + 'K:\Minecraft Narrative Studio' + "`nCommand: " + 'K:\Applications\Codex\codex.EXE --search exec --ephemeral --sandbox read-only --skip-git-repo-check --color never -C K:\Minecraft Narrative Studio --output-schema C:\Users\Admin\AppData\Local\Temp\mcstudio-codex-zzzoftdf\proposal-schema.json -o C:\Users\Admin\AppData\Local\Temp\mcstudio-codex-zzzoftdf\proposal.json -m gpt-5.6-sol -c model_reasoning_effort="max" -' + "`n") -Encoding utf8
$exitCode = 1
try {
    $start = @{
        FilePath = 'K:\Applications\Codex\codex.EXE'
        ArgumentList = '--search exec --ephemeral --sandbox read-only --skip-git-repo-check --color never -C "K:\Minecraft Narrative Studio" --output-schema C:\Users\Admin\AppData\Local\Temp\mcstudio-codex-zzzoftdf\proposal-schema.json -o C:\Users\Admin\AppData\Local\Temp\mcstudio-codex-zzzoftdf\proposal.json -m gpt-5.6-sol -c model_reasoning_effort=\"max\" -'
        WorkingDirectory = 'K:\Minecraft Narrative Studio'
        RedirectStandardOutput = $stdoutPath
        RedirectStandardError = $stderrPath
        PassThru = $true
        NoNewWindow = $true
        RedirectStandardInput = 'K:\Minecraft Narrative Studio\exports\runner-logs\20260715-202959-843745-studio-assistant-codex-gpt-5.stdin.txt'
    }
